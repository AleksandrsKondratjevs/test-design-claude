...
define(["Magento_PageBuilder/js/mass-converter/widget-directive-abstract", "Magento_PageBuilder/js/utils/object"], function (_widgetDirectiveAbstract, _object) {
  ...
  var WidgetDirective = /*#__PURE__*/function (_widgetDirectiveAbstr) {
    ...
    _proto.fromDom = function fromDom(data, config) {
      ...
      data.grid_columns_desktop = attributes.grid_columns_desktop;
      data.grid_columns_tablet = attributes.grid_columns_tablet;
      data.grid_columns_mobile = attributes.grid_columns_mobile;
      data.show_all_button_text = attributes.show_all_button_text;
      data.show_all_button_type = attributes.show_all_button_type;
      data.block_title = attributes.block_title;
      data.block_sub_title = attributes.block_sub_title;
      data.is_show_all_enabled = attributes.is_show_all_enabled;

      if (attributes.show_all_button_url) {
        data.show_all_button_url = JSON.parse(this.decodeWysiwygCharacters(attributes.show_all_button_url));
      }
    ...
    _proto.toDom = function toDom(data, config) {
      var attributes = {
        ...
        show_all_button_text: data.show_all_button_text,
        show_all_button_type: data.show_all_button_type,
      ...
      if (data.show_all_button_url) {
        attributes.show_all_button_url = this.encodeWysiwygCharacters(JSON.stringify(data.show_all_button_url));
      }
