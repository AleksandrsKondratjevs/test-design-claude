...
define([
    ...
    return dynamicRows.extend({
        ...
        initLinks: function () {
            this._super();
            Events.on(
                "notification-carousel:saveAfter",
                function (data) {
        ...
        /**
         * Open the Notification Carousel modal and insert form with the data from selected record
         *
         * @param {Object} record
         */
        ...
        sortByHeader: function (property) {
            var ascend, activeLabel, allLabels, placeholder;
            ...
            if (property().columnsHeaderClasses) {
                ...
                activeLabel.columnsHeaderClasses =
                    property().columnsHeaderClasses === "_ascend"
                        ? "_descend"
                        : "_ascend";
