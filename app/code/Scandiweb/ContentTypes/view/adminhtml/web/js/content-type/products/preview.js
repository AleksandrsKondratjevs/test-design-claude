...
define(["jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "slick", "underscore", "Magento_PageBuilder/js/config", "Magento_PageBuilder/js/content-type-menu/hide-show-option", "Magento_PageBuilder/js/content-type/preview", "Scandiweb_ContentTypes/js/content-type/products/mass-converter/widget-directive", "Scandiweb_ContentTypes/js/content-type/products/mass-converter/carousel-widget-directive"], function (_jquery, _knockout, _translate, _events, _slick, _underscore, _config, _hideShowOption, _preview, _widgetDirective, _carouselWidgetDirective) {
  /**
  ...
  var Preview = /*#__PURE__*/function (_preview2) {
    ...
    _proto.afterObservablesUpdated = function afterObservablesUpdated() {
      ...
      if (this.hasDataChanged(this.previousData, data)) {
        ...
        var previewData = Object.assign({}, data, { preview: true });

        var converter = data.appearance === "carousel" 
          ? new _carouselWidgetDirective() 
          : new _widgetDirective();

        var convertedData = converter.toDom(previewData, { html_variable: "html" });
        var directive = convertedData && convertedData.html 
          ? convertedData.html 
          : this.data.main.html();
